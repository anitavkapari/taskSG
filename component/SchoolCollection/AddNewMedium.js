...
export default class AddNewMedium extends Component {
 ...
 componentDidMount(){}
    ...
    return (
		...
		<Text style={style.welcome1}>School/Collection/Add New Medium</Text>
 ...
 style={style.inputBox}
  ...
  <Picker.Item label="10002" value="js" />
		  ...
		  <TextInput style={style.inputtxt} placeholder='Semi English' 
