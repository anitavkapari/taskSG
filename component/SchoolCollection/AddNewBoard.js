...
export default class AddNewBoard extends Component {
 ...
 componentDidMount(){}
    ...
    return (
		...
		<Text style={style.welcome1}>School/Collection/Add New Board</Text>

		 <View style={{marginTop:10}}>
          <View style={{flexDirection: 'row',marginTop:5,height:40,justifyContent: 'space-around',
    alignItems: 'center',backgroundColor:'rgba(80,80,110,.170)',
 ...
 style={style.inputBox}
  ...
  <Picker.Item label="10002" value="js" />
		  ...
		  <TextInput style={style.inputtxt} placeholder='CBSE' 
