...
export default class AddNewGest extends Component {
 ...
 componentDidMount(){}
    ...
    return (
         ...
         <Text style={style.welcome1}>Professor/Employee/Add New Gest</Text>
    ...
    alignItems: 'center',backgroundColor:'#808080', borderWidth: 1.0,borderColor: '#ffffff',}}>
			...
			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Gest English</Text>
<View style={{flexDirection: 'row',justifyContent: 'space-around',}}>
		  ...
		  />
		    			...
		    			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Gest  2nd Language</Text>
<View style={{flexDirection: 'row',justifyContent: 'space-around',}}>
		  <TextInput style={style.inputtxt}  
		  onChangeText={RfName => this.setState({RfName})}
		  placeholder="First Name"				  
