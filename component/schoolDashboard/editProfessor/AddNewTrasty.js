...
export default class AddNewTrasty extends Component {
 ...
 componentDidMount(){}
    ...
    return (
         ...
         <Text style={style.welcome1}>Professor/Employee/Add New Trasty</Text>
    ...
    alignItems: 'center',backgroundColor:'#808080', borderWidth: 1.0,borderColor: '#ffffff',}}>
			...
			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Trasty English</Text>
<View style={{flexDirection: 'row',flex: 1,alignItems: 'flex-start'}}>
		  ...
		  />
		    			...
		    			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Trasty  2nd Language</Text>
