...
export default class AddNewInspector extends Component {
 ...
 componentDidMount(){}
    ...
    return (
         ...
         <Text style={style.welcome1}>Professor/Employee/Add New Inspector</Text>
    ...
    alignItems: 'center',backgroundColor:'#808080', borderWidth: 1.0,borderColor: '#ffffff',}}>
			<Text>id</Text>
			<Text>Last Added Inspector</Text>
			<Text>Date/Time</Text>
		  </View>
		  </View>
			...
			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Inspector English</Text>
<View style={{flexDirection: 'row',justifyContent: 'space-around',}}>
		  ...
		  />
		    			...
		    			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Inspector  2nd Language</Text>
<View style={{flexDirection: 'row',justifyContent: 'space-around',}}>
		  <TextInput style={style.inputtxt}  
		  onChangeText={RfName => this.setState({RfName})}
		  placeholder="First Name"				  
