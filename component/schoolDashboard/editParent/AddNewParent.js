...
export default class AddNewParent extends Component {
 ...
 componentDidMount(){}
    ...
    return (
         ...
         <Text style={style.welcome1}>Parent/Add New Parent</Text>
    ...
    alignItems: 'center',backgroundColor:'#808080', borderWidth: 1.0,borderColor: '#ffffff',}}>
			...
			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Parent English</Text>
<View style={{flexDirection: 'row',justifyContent: 'space-around',}}>
		  ...
		  />
		    			...
		    			<Text style={{fontWeight: 'bold',fontSize:14}}>Name of Parent  2nd Language</Text>
<View style={{flexDirection: 'row',justifyContent: 'space-around',}}>
		  <TextInput style={style.inputtxt}  
		  onChangeText={RfName => this.setState({RfName})}
		  placeholder="First Name"				  
