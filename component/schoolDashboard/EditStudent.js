...
static navigationOptions = {
	...
	<View style={style.container}>
				 <ScrollView>
		<Text style={style.welcome1}>Student</Text>
 ...
 <Text style={style.separator}onPress={() => this.props.controller({screen:2,subscreen:0})}>Add New Student</Text>
 <Text style={style.separator}onPress={() => this.props.controller(3)}>Allocat Task </Text>
 <Text style={style.separator}onPress={() => this.props.controller(4)}>Update Student Information</Text> 
 <Text style={style.separator}onPress={() => this.props.controller(5)}>Allocat Plan</Text>	    

		
 <Text style={style.separator}onPress={() => this.props.controller(9)}>Verification of Student</Text>
