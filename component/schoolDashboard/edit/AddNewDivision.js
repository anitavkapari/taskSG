...
export default class AddNewDivision extends Component {
...
ListViewItemSeparator = () => {
  ...
  SearchFilterFunction(text){
    ...
    return (
         ...
         <Text style={style.welcome}>School/Add New Division</Text>
		      <ScrollView>
...
<ListView style={{marginTop: 10,backgroundColor: "#dbd5d0",}}
  dataSource={this.state.dataSource}
      ...
      />
	   <View style={{marginTop:10}}>
		<Text style={style.txt}>Already Division</Text>
					   </View>
...
<ListView style={{marginTop: 10,backgroundColor: "#dbd5d0",}}
  dataSource={this.state.dataSource}
      ...
      />
	   <View style={{marginTop:10}}>
		<Text style={style.txt}>Add new  Division</Text>
					   </View>
