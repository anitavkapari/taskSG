...
export default class AllocateTeacher extends Component {
...
ListViewItemSeparator = () => {
  ...
  SearchFilterFunction(text){
    ...
    return (
         ...
         <Text style={style.welcome}>School/Allocate Teacher</Text>
		      <ScrollView>
...
<View style={{flexDirection: 'column',backgroundColor:'rgba(80,80,110,.170)', }}> 
		<Text style={style.txt}>2018 - 2019</Text>
			  ...
			  <View style={{marginTop:10}}>
		<Text style={style.txt}>Class Teacher</Text>
					   </View>
...
<ListView style={{marginTop: 10,backgroundColor: "#dbd5d0",}}
  dataSource={this.state.dataSource}
      ...
      />
	  <View style={{marginTop:10}}>
		<Text style={style.txt}> Subject Teacher</Text>
					   </View>
...
<ListView style={{marginTop: 10,backgroundColor: "#dbd5d0",}}
  dataSource={this.state.dataSource}
       ...
       <View style={{flex:1, flexDirection: 'column'}} >
         <TouchableOpacity>
         <Text style={style.txt} >stda5555</Text>
         <Text style={style.txt} >Marathi</Text>
         <Text style={style.txt} >Hindi</Text>
         </TouchableOpacity>
       </View>
        }
