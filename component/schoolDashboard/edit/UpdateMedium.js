...
export default class UpdateMedium extends Component {
...
ListViewItemSeparator = () => {
  ...
  SearchFilterFunction(text){
    ...
    return (
         ...
         <Text style={style.welcome}>School/UpdateMedium</Text>
		      <ScrollView>
  ...
  dataSource={this.state.dataSource}
      ...
      />
	   <View style={{marginTop:10}}>
		...
		<Text style={style.txt}>Select Board</Text>
					   </View>
  ...
  dataSource={this.state.dataSource}
      ...
      />
	   <View style={{marginTop:10}}>
		...
		<Text style={style.txt}>Select Medium</Text>
					   </View>
