...
import { StyleSheet, View, Dimensions, Platform, ScrollView, ImageBackground, TouchableOpacity, Text, Image, TouchableHighlight } from "react-native";
		...
		<View
			...
			<View style={style.separator}>
				...
				<View style={{ flexDirection: 'column', marginTop: 8, backgroundColor: 'sandybrown', padding: 10 }}>
					<Text style={{ fontWeight: 'bold', fontSize: 35, color: '#ffffff', textAlign: 'center' }}>GuruDevSchool</Text>
					<Text style={{ fontWeight: 'bold', fontSize: 18, color: '#ffffff', textAlign: 'center' }}>Online Education App</Text>
				</View>
			</View>
			...
			<View>
				<ScrollView
					horizontal={true}
				>
					<TouchableHighlight onPress={() => props.parentClickHandler()}>
					...
					<TouchableHighlight onPress={() => props.studentClickHandler()}>
						<View style={[style.SectionStyle, { width: screenWidth }]}>
							<Image
								source={{
									uri:
			...
			<View style={{ flexDirection: 'row', marginTop: 5, backgroundColor: 'lightsalmon' }}>
				<Text style={{ color: 'black', margin: 5, fontWeight: 'bold', fontSize: 14 }}>Current Location</Text>
				<Image style={{ width: 30, height: 30, padding: 5, margin: 3, marginLeft: 130 }}
